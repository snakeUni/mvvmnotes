...
var ReactFiberScheduler = function (config) {
  ...
  function requestWork(root, expirationTime) {
    ...
    if (isBatchingUpdates) {
      console.log("isBatchingUpdates:", isBatchingUpdates, "isUnbatchingUpdates:",isUnbatchingUpdates)
    ...
    if (expirationTime === Sync) {
      console.log("同步调用:expirationTime : Sync", expirationTime, Sync)
      console.log("同步调用:performSyncWork")
      performSyncWork();
    } else {
      console.log("异步调用：scheduleCallbackWithExpiration")
